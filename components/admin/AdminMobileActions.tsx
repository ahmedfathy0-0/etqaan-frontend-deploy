...
export default function AdminMobileActions({
  ...
  if (!["overview", "users", "batches"].includes(activeTab)) return null;

  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex h-[88px] gap-2 rounded-t-2xl bg-neutral-200 px-4 py-4 shadow-[0_-2px_30px_4px_rgba(0,0,0,0.15)] lg:hidden" dir="rtl">
